...
export default function StudentDashboard() {
  ...
  return (
    <StudentLayout title="Dashboard">
      {/*
        Minimal change: apply a left-only negative margin on mobile so the content uses the layout's left gutter,
        but reset it at the sm breakpoint so desktop dimensions remain unchanged.
        -ml-4 applies on mobile (<640px), sm:ml-0 resets margin on larger screens.
      */}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-3 flex items-center gap-2 text-xs text-gray-600">
                            <div className="inline-flex items-center gap-2">
                              ...
                              <span className="text-gray-500 truncate">{room}</span>
                            </div>

                            {section && (
                              <div className="inline-flex items-center gap-2 ml-3">
                                <span className="font-medium text-gray-700">Section:</span>
                                <span className="text-gray-500 truncate">{section}</span>
                              </div>
                            )}
                          </div>
                        </div>
