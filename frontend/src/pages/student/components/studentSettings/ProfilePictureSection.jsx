...
export default function ProfilePictureSection({
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
    <div className="bg-white rounded-xl shadow-lg p-8 w-[500px] max-w-[90%] flex flex-col items-center">
      <CameraView
        webcamRef={webcamRef}
        videoConstraints={{ ...videoConstraints, width: 480, height: 480 }}
        onError={handleUserMediaError}
        onStarted={(videoEl) => startPipelines && startPipelines(videoEl)}
      ...
      <div className="flex gap-4">
        ...
        <button
          onClick={handleClose}
          className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-5 py-2 rounded-lg text-sm font-medium transition"
        >
          Cancel
        </button>
      </div>
