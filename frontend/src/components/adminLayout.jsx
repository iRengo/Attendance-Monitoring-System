...
import { Home,  Users,  ClipboardList,  GraduationCap,  Megaphone,  BarChart3,  Settings, ChevronDown, Menu,  LogOut,  Bell} from "lucide-react";
...
export default function AdminLayout({ title, children }) {
  ...
  { name: "Class Management", path: "/admin/classes", icon: <GraduationCap size={20} /> },
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  <span className="font-medium text-[#32487E]">Professor X.</span>
