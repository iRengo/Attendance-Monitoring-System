...
import {
  parseTimeToTimestampZone,
  buildClassDocWithZone,
} from "./TeacherService.timezone-fix";
...
export class TeacherService {
  ...
  private buildClassDoc(data: any) {
    const zone = process.env.SCHOOL_TIMEZONE ?? "Asia/Manila";
    return buildClassDocWithZone(data, zone);
  }
